...
urlpatterns = [
    ...
    url(r'^article-detail/(?P<id>\d+)/(?P<slug>[-\w]+)/$', views.article_detail,
        name='article_detail'),
    ...
    url(r'^list-article-detail/(?P<id>\d+)/(?P<slug>[-\w]+)/$', list_views.article_detail,
        name='list_article_detail'),
    ...
    url(r'^dle-article-tag/$', views.del_article_tag, name="del_article_tag"),
]
